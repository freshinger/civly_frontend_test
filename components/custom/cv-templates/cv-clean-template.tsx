...
export function CVCleanTemplate({
  ...
  return (
    <>
      ...
      <div
        className="cv-page w-[794px] bg-white mx-auto relative"
      ...
      >
        ...
        {/* Main Content Grid */}
        <div
          className="grid grid-cols-[300px_1fr] gap-8 px-12 py-8 print:px-12 print:py-4"
              ...
              >
                ...
                {cvData.personalInformation.website && (
                  ...
                  >
                    ...
                    <span>
                      {cvData.personalInformation.website.replace(
                        'https://',
                        '',
                      )}
                    </span>
              ...
              <div className="space-y-3 print:space-y-2">
                {cvData.education.map((edu, index) => (
                  ...
                  >
                    ...
                    {edu.description && (
                      <div className="text-gray-600 mt-1 orphans-2 widows-2">
                        {edu.description}
                      </div>
                    )}
                  </div>
                  ...
                  <div className="space-y-1 print:space-y-0.5">
                    {skillGroup.skills
                      ...
                      .map((skill, skillIndex) => (
                        <div
                          key={skillIndex}
                          className="text-xs text-black break-inside-avoid"
                          style={{ lineHeight: '1.3' }}
                        >
                          {skill.name}
                        </div>
              ...
              <div className="space-y-5 print:space-y-3">
                {cvData.experience.map((work, index) => (
                  <div key={index} className="break-inside-avoid">
                    ...
                    {work.description && (
                      <div
                        className="text-xs text-black orphans-3 widows-3"
                        style={{ lineHeight: '1.5' }}
                      >
                        {work.description}
                      </div>
